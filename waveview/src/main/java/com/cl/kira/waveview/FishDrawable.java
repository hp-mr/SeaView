...
public class FishDrawable extends Drawable {
    public static final String TAG = "Jcs_Fishsss";
    public  float HEAD_RADIUS=20;
    protected   float BODY_LENGHT=HEAD_RADIUS * 3.2f;
    public   int BODY_ALPHA = 220;
    public   int OTHER_ALPHA = 160;
    public   int FINS_ALPHA = 100;
    public   int FINS_LEFT = 1;//左鱼鳍
    public   int FINS_RIGHT = -1;
    public   float FINS_LENGTH = HEAD_RADIUS * 1.3f;
    public   float TOTAL_LENGTH= 6.79f * HEAD_RADIUS;
    ...
    public FishDrawable(Context context,int R,int G,int B) {
    ...
    private void init() {
        ...
        mPaint.setColor(Color.argb(OTHER_ALPHA, R, G, B));
        //身体画笔
        bodyPaint = new Paint();
        bodyPaint.setAntiAlias(true);
        bodyPaint.setStyle(Paint.Style.FILL);
        bodyPaint.setDither(true);//防抖
        bodyPaint.setColor(Color.argb(OTHER_ALPHA + 5, R, G, B));
...
//				mainAngle = currentValue % 360;
    ...
    private void makeBody(Canvas canvas, float headRadius) {
        ...
        mPaint.setColor(Color.argb(BODY_ALPHA, R, G, B));
        //画最大的身子
    ...
    private void makeFins(Canvas canvas, PointF startPoint, int type, float fatherAngle) {
        ...
        mPaint.setColor(Color.argb(FINS_ALPHA, R, G, B));
        canvas.drawPath(mPath, mPaint);
        mPaint.setColor(Color.argb(OTHER_ALPHA, R, G, B));
